...
class Factigis_BusquedaFolio extends React.Component {
  ...
  onSearchFolio(){
    ...
    var c = factigis_findFolio(this.state.bf_folio, cb=>{
      ...
      this.setState({
        ...
        //04.12.2018: rescatar valores de folio con respecto a la empresa que pertenece.
        dataFolio: reg,
        dataGeoFolio: ubi
  ...
  onPrint(){
    ...
    cookieHandler.set("folio", this.state.bf_folio);
    window.open("factigisCertificado.html");
  }
