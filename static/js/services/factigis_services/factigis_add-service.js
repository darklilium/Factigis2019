          ...
          //variables a usar en formula
            ...
            buscarCantClienteSED(factibilidad.factigis_Sed, (cantidadClientes)=>{
              var kva = buscarKVASED(factibilidad.factigis_Sed, (kva)=>{
                //25.06.2019: cambio de factor 5 a 6 kWh
                ...
                //25.04.2019: cambio en distancia rotulo medidor segun requerimiento.
...
function agregarFact(f, callback){
  ...
  console.log(f.factigis_Sed,"sed?", "empalme: ",  f.factigisTipoEmpalme);
  var tipoEmpalme = f.factigisEmpalme;
  ...
  if(sedd>0){
    ...
    var niv = searchNivelesCoci(sedd, f.factigisEmpresa)
      .then(niveles=>{
        console.log(niveles,"tengo niveles de sed", sedd);
          ...
          console.log("agregando... 1 ",myAttributes);
    ...
    console.log("agregando...2 ",myAttributes);
...
function agregarFactEspecial(f, callback){
  console.log(f,"tengo esta fac en add nueva")
  let posteFactibilizador;
  let opcionCampamento, opcionConcesion, opcionVialidad, opcionTransmision, opcionRestringida;
  ...
  if(sedd>0){
    ...
    var niv =  searchNivelesCoci(sedd, f.factigisEmpresa)
      .then(niveles=>{
        ...
        console.log("agregando especial...1",myAttributes);
    ...
    console.log("no se puede encontrar nivel coci fact especial");
      ...
      console.log("agregando especial...2 ",myAttributes);
